        ...
        <section>
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/cross-margin">Link_W</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/isolated-margin">Link_X</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/risk-management">Link_Y</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/trading-bots">Link_Z</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/advanced-trading">Link_AA</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/launchpad">Link_AB</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/options-trading">Link_AC</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/p2p-trading">Link_AD</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/fee-tiers">Link_AE</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/perpetuals-guide">Link_AF</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
                <td><a href="/exchanges/binance/sub-accounts">Link_AG</a></td>
              </tr>
              <tr>
                <td>Child_Page</td>
