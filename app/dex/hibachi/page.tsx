        ...
        "@graph": [
          {
            ...
            "name": "Hibachi",
            "description": "Solana-native perpetual futures DEX with 100x leverage and sub-second execution",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "data": {
              ...
              "blockchain": "Solana",
              "trading_fee_maker": "0.03%",
              "trading_fee_taker": "0.07%",
              "max_leverage": "100x",
              "kyc_required": false,
              "daily_volume": "$500M+",
              "execution_speed": "sub-400ms",
              "gas_costs": "~$0.01",
              "best_for": [
                "solana_ecosystem",
                "fast_execution",
              ...
              "pros": [
                "Ultra-fast execution (sub-second)",
                "Extremely low fees (Solana gas)",
              ...
              "cons": [
                ...
                "Lower liquidity ($500M vs competitors)",
                "Network dependency on Solana uptime",
                "Lower max leverage than AsterDEX",
                "Smaller ecosystem and trading pairs",
                "Potential slippage on large orders"
              ],
              "supported_wallets": ["Phantom", "Solflare", "Backpack", "Ledger"],
              "trading_pairs": ["BTC", "ETH", "SOL", "major altcoins"],
              "comparison_vs_competitors": {
                "vs_asterdex": {
                  "leverage": "100x vs 1001x (lower)",
                  "chains": "Solana-only vs multi-chain",
                  "volume": "$500M vs $32B (64x lower)",
                  "speed": "comparable (both sub-second)",
                  "fees": "0.03%/0.07% vs 0.02%/0.05% (slightly higher)"
                },
                "vs_hyperliquid": {
                  "leverage": "100x vs 50x (2x higher)",
                  "volume": "$500M vs $9B (18x lower)",
                  "fees": "0.03%/0.07% vs 0.02%/0.05% (slightly higher)",
                  "gas": "Solana fees vs zero fees"
                }
              },
              "use_cases": {
                "ideal_for": "Solana ecosystem traders seeking fast perpetual futures",
                "not_ideal_for": "Multi-chain traders or those needing maximum leverage"
              },
              "last_updated": "2025-11-13",
              "data_source": "official Hibachi sources and blockchain data"
            }
          })
        }}
      />
