        ...
        <section>
          ...
          <table>
            <tbody>
              ...
              <tr><td>Chain_Type</td><td>Not_Disclosed</td></tr>
              <tr><td>Gas_Model</td><td>Not_Disclosed</td></tr>
              <tr><td>Settlement_Model</td><td>Not_Disclosed</td></tr>
            </tbody>
          </table>
        </section>
        ...
        <section>
          ...
          <table>
            <tbody>
              ...
              <tr><td>Fee_Model</td><td>Not_Disclosed</td></tr>
            </tbody>
          </table>
        </section>
